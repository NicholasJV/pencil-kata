...
describe("Combination test : ", function(){
    ...
    it("writes, erases, sharpens and edits, together with proper point, eraser degradation", function(){
...
describe("Functional combination test : ", function(){
    ...
    function(){
        ...
        writer.pencil.sharpen() // change to be able to chain off sharpen
        writer.insertEdit('cters plus 5 and another some').pencil.sharpen()
        expect(test_page.text).toBe("This Text is 22 Characters @@@@ @")

        writer.write(" I'm dying...").erase('This Text').pencil.sharpen()
